...
class JediDataset(object):
    ...
    def __init__(self, features_path, dataset, noise_rate = 0.1):
    ...
    def load_text_dataset_from_pkl(self):
        ...
        self.test_Y = self._fetch_pkl_file_as_array(os.path.join(self.features_path,'labels_test_gt.pickle'))
